    ...
    <div class="container">
        <form action="/posts/update/<?php echo $post['id']; ?>" method="post">
            <div class="form-group">
                ...
                <input type="text" name="title" class="form-control" aria-describedby="emailHelp" value=<?php echo $post['title']; ?>>
            ...
            <div class="form-group">
                ...
                <select  class="form-control" name="author">
                    ...
                    foreach($authors as $author) {
                        if($post['author_id'] == $author->getAuthorId()){
                            echo '<option selected value="'.$author->getAuthorId().'">'.$author->getAuthorName().'</option>';
                        }else {
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="status">
                    ...
                    foreach($statuses as $status) {
                        if($post['status_id'] == $status->getStatusId()){
                            echo '<option selected value="'.$status->getStatusId().'">'.$status->getStatusName().'</option>';
                        }else {
            ...
            <div class="form-group">
                ...
                <select  class="form-control" name="category">
                    ...
                    foreach($categories as $category) {
                        if($post['category_id'] == $category->getCatId()){
                            echo '<option selected value="'.$category->getCatId().'">'.$category->getCatName().'</option>';
                        }else {
            ...
            <div class="form-group">
                ...
                <input type="text" name="img" class="form-control" id="exampleInputPassword1" value=<?php echo $post['img']; ?>>
